    ...
    window.onload = function(){
        ...
        var mapSVG = document.getElementById('newMap');
        mapSVG.setAttribute('viewBox', '0 0 900 1400');
        var VB = mapSVG.getAttribute('viewBox').split(' ').map(c=>+c);
        var DMAX = VB.slice(2);
        var WMIN = 480;
        var NF = 1;
        let nav = null;
        ...
        function update(){
            ...
            mapSVG.setAttribute('viewBox', cvb.join(' '));
